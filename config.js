...
config.voices = [
    ...
    {image: 'ding.png', file: 'bss_tide_spincycle_swell_', count:14, min: 1.5, max: 3.0},  
    {image: 'waffle.png', file: 'bss_tide_spincycle_chime_', count:9, min: 3.0}, 
    {image: 'leggo.png', file: 'bss_tide_spincycle_melody_', count:21},
    {image: 'toaster.png', file: 'bss_tide_spincycle_sfx_', count:12}
];
